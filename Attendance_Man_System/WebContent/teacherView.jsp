...
cfg1.configure("resources/HibernateTeacher.cfg.xml");
SessionFactory sf1=cfg1.buildSessionFactory();
Session s1=sf1.openSession();



Criteria c=s1.createCriteria(PojoForTeacherAdd.class);

Criterion cr=Restrictions.eq("email", userid);


c.add(cr);

PojoForTeacherAdd pt=(PojoForTeacherAdd)c.uniqueResult();
...
<h2 align="center"><a href="teacherlogin.html">Back</a></h2>
</body>
</html>
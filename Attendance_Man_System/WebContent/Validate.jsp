...
<h1><a href="index.html">Home</a></h1>
       ...
       <h2 align="center" ><a href="studentlogin.jsp">Again Enter UserId & Password </a></h2>
</pre>
<%
...
<%
		...
		String pass=request.getParameter("password");
                                        ...
                                        Class.forName("com.mysql.jdbc.Driver");
                                         ...
                                         PreparedStatement ps=con.prepareStatement("select id,password from student_registration");
